...
const UserCard: React.FC<UserCardProps> = ({ uid, profileImage, firstname, lastname, online, onAddFriend, onChatStart }) => {
  return (
    <div className="flex items-center p-3 dark:bg-neutral-700 dark:bg-gradient-to-l from-neutral-900 to-neutral-950 shadow-md rounded-xl border-2 border-gray-800 transition-transform transform hover:scale-105">
      {profileImage ? (<Image
        src={profileImage}
        width={400}
        height={400}
